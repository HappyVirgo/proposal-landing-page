...
const TabsComponent = ({history, attachments, notes}) => { 
    ...
    let notesCount_Workorders = notes?notes.data.response.workOrderNotes:[]
    notesCount_Workorders = notesCount_Workorders?notesCount_Workorders.length:0
    let notesCount_Proposal = notes?notes.data.response.proposalNotes:[]
    notesCount_Proposal = notesCount_Proposal?notesCount_Proposal.length:0
    let notesCount_Invoices = notes?notes.data.response.invoiceNotes:[]
